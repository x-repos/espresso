...
def base_input(prefix, calc="relax", nspin=2):
    inp = {
        "control": {
            ...
            "pseudo_dir": PSEUDO_DIR, "outdir": "./out/",
...
def main():
    ...
    write_qe(HERE / "mg2ni_NbFeMg.in",   mg2ni_NbFeMg,   "mg2ni_NbFeMg",   kpts=(8, 8, 4))
    write_qe(HERE / "mg2nih4_NbFeMg.in", mg2nih4_NbFeMg, "mg2nih4_NbFeMg", kpts=(8, 8, 6))

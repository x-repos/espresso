...
def main():
    ...
    write_qe(HERE / "mg2ni_Nb.in",   mg2ni_Nb,   "mg2ni_Nb",   calc="relax", kpts=(8, 8, 4))
    write_qe(HERE / "mg2nih4_Nb.in", mg2nih4_Nb, "mg2nih4_Nb", calc="relax", kpts=(8, 8, 6))
    ...
    write_qe(HERE / "mg2ni_NbFe.in",   mg2ni_NbFe,   "mg2ni_NbFe",   calc="relax",
             kpts=(8, 8, 4), nspin=2, magnetic_species={"Fe": 2.0})
    write_qe(HERE / "mg2nih4_NbFe.in", mg2nih4_NbFe, "mg2nih4_NbFe", calc="relax",
    ...
    write_qe(HERE / "mgo.in", mgo, "mgo", calc="scf", kpts=(8, 8, 8))
    ...
    write_qe(HERE / "nb2o5.in", nb2o5, "nb2o5", calc="vc-relax", kpts=(4, 4, 4))

...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{struct_combined.png}
    \caption{Ball-and-stick representations of the simulated unit cells. \textbf{(a)} Pristine $\text{Mg}_2\text{NiH}_4$ (System 0). \textbf{(b)} Nb-doped $\text{Mg}_2\text{NiH}_4\text{:Nb}$ (System 1). \textbf{(c)} Co-doped $\text{Mg}_2\text{NiH}_4\text{:Nb,Fe}$ representing System 2. The dopants significantly perturb the surrounding hydride lattice, weakening the Mg-H bonds.}
    \label{fig:crystals}
\end{figure}
